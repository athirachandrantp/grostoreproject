...
function form_validation(){
    ...
    console.log(address);
    var mobiles = document.getElementById('a_number').value;
    var text = /^\d{10}$/;
    console.log(mobiles);
    var email = document.getElementById('a_username').value;
    var re = /\S+@\S+\.\S+/;
    console.log(email);
    var password = document.getElementById('a_password').value;
    var pass = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/;
    console.log(password);
    var cpassword = document.getElementById('a_confirmpassword').value;
    ...
    //special character
        ...
        // a_name.style.borderColor = "black";
        flag=1;
    }
    if(address == ""){
        ...
        // a_address.style.borderColor = "black";
        flag=1;
    }
    if(mobiles ==""){
    ...
    if(email == ""){
        username_error.innerHTML = 'please enter an email';
